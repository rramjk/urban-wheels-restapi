...
import ru.ramazanov.UrbanWheels.models.Role;
...
public class UserDto {
    ...
    public UserDto(int id, String name, String lastName, String email, String passport, String driverLicence, String photo, Role role, String password) {
        this.id = id;
        this.name = name;
